      ...
      <div className={styles.checkout__wrapper}>
        ...
        >
          {user?.basket?.length > 0 ? (
            user?.basket?.map((item) => <BasketItem item={item} />)
          ) : (
            <Text color="white" fontSize="1.5rem">
              You have nothing in your basket. So{" "}
              <NavLink style={{ textDecoration: "underline" }} to="/products">
                go shopping
              </NavLink>
              , i guess?
            </Text>
        ...
        >
          ...
          <Box
            ...
            p="1rem"
          >
            <Swiper modules={[Pagination, Navigation, A11y]} navigation>
